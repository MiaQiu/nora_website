...
import { ArrowLeft, Briefcase, Heart, Users, Clock, MessageCircle, Calendar, Users as UsersIcon } from "lucide-react";
...
const specialists = [
  ...
  {
    name: "Dr. Marcus Chen",
    title: "Career Transition & Work-Life Balance Coach",
    experience: "18 years experience",
    image: "/images/specialists/dr-marcus-chen.jpg",
    about: "Career Transition & Work-Life Balance Coaches help parents navigate the complex transition back to work, manage career advancement, and maintain family harmony.",
    languages: ["English", "Mandarin", "Cantonese"],
    specialties: ["Career transition planning", "Work-life balance strategies", "Professional development", "Return-to-work confidence", "Time management", "Career-family integration"],
    cancellationPolicy: "24-hour notice required; flexible scheduling for career transitions",
    rating: 4.9,
    reviewCount: 167
  }
];
...
export default function ReturnToWork() {
  ...
  const subCategories = [
    {
      ...
      description: "Strategic guidance for successfully returning to work after parental leave with confidence and purpose.",
      icon: Briefcase,
      color: "from-blue-500 to-cyan-500",
      topics: ["Return-to-work strategy", "Career goal setting", "Skill assessment", "Industry updates", "Networking strategies", "Confidence building"],
      matchedSpecialists: ["Dr. Marcus Chen", "Dr. Priya Sharma"]
    },
    {
      id: "work-life-balance",
      title: "Work-Life Balance",
      description: "Practical strategies for managing career demands while maintaining family harmony and personal wellbeing.",
      icon: Heart,
      color: "from-green-500 to-emerald-500",
      topics: ["Time management", "Boundary setting", "Stress management", "Self-care routines", "Family time optimization", "Burnout prevention"],
      matchedSpecialists: ["Dr. Janet Loh", "Dr. Marcus Chen"]
    },
    {
      id: "professional-development",
      title: "Professional Development",
      description: "Continued career growth and skill development while balancing family responsibilities.",
      icon: Users,
      color: "from-purple-500 to-indigo-500",
      topics: ["Skill development", "Leadership training", "Mentorship", "Professional networking", "Career advancement", "Industry knowledge"],
      matchedSpecialists: ["Dr. Marcus Chen", "Dr. Priya Sharma"]
    },
    {
      id: "family-integration",
      title: "Family-Career Integration",
      description: "Building sustainable systems that support both career success and family wellbeing.",
      icon: Heart,
      color: "from-pink-500 to-rose-500",
      topics: ["Family support systems", "Childcare coordination", "Emergency planning", "Communication strategies", "Flexible work arrangements", "Cultural integration"],
  ...
  return (
    <>
      <SEOHead
        title="Return to Work - Expert Guidance for Working Parents | AskFellow"
        description="Professional support for parents returning to work, managing work-life balance, and advancing careers while maintaining family harmony from experienced specialists."
        keywords="return to work, work-life balance, career transition, professional development, working parents, family-career integration"
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-xs sm:text-sm font-medium text-primary">Career Success</span>
                    </motion.div>
                    ...
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 sm:mb-6 px-2">
                      ...
                      <span className="text-charcoal">& Career Guidance</span>
                    </h1>
                    <p className="text-base sm:text-lg lg:text-xl text-charcoal max-w-3xl mx-auto leading-relaxed px-4">
                      Professional support for <span className="font-semibold text-secondary">parents returning to work, managing work-life balance, and advancing careers</span> while{" "}
                ...
                >
                  <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-primary/10">
                    ...
                    <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                      Every parent's career journey is unique. Connect with our expert specialists for personalized guidance 
                      tailored to your specific career goals and family needs.
                    </p>
