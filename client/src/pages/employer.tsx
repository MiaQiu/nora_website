            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div>
                  ...
                  <motion.p
                    className="text-base sm:text-lg md:text-xl text-charcoal/80 mb-8 leading-relaxed"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="text-center mb-8 sm:mb-12">
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-charcoal mb-3">The Hidden Cost of Unsupported Parents</h3>
                  <p className="text-base sm:text-lg text-charcoal/80 max-w-2xl mx-auto px-4">Understanding the real impact on your workforce and bottom line</p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12 max-w-4xl mx-auto px-4">
                  ...
                  >
                    <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-charcoal mb-2">32</div>
                    <div className="text-sm sm:text-base text-charcoal/80 mb-1 font-semibold">hours per week</div>
                    <p className="text-charcoal/70 text-sm sm:text-base">Unseen mental load burden</p>
                  </motion.div>
                  <motion.div 
                    className="text-center"
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-charcoal mb-2">48%</div>
                    <div className="text-sm sm:text-base text-charcoal/80 mb-1 font-semibold">of parents</div>
                    <p className="text-charcoal/70 text-sm sm:text-base">Feel completely overwhelmed daily</p>
                  </motion.div>
                  <motion.div 
                    className="text-center"
                    initial={{ opacity: 0, y: 20 }}
                    ...
                    transition={{ delay: 0.3 }}
                  >
                    <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-charcoal mb-2">$3.8T</div>
                    <div className="text-sm sm:text-base text-charcoal/80 mb-1 font-semibold">economic value</div>
                    <p className="text-charcoal/70 text-sm sm:text-base">Of unpaid parental mental labor</p>
                  </motion.div>
                </div>
              </motion.div>
            </div>
          ...
          <section className="py-20 sm:py-24 lg:py-32 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                ...
                <motion.p 
                  className="text-base sm:text-lg md:text-xl text-charcoal/80 max-w-4xl mx-auto leading-relaxed px-4"
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.2 }}
                >
              ...
              >
                ...
                <div className="lg:col-span-7 xl:col-span-7 px-4 lg:px-0">
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 text-gradient-primary">{active.title}</h3>
                  <p className="text-base sm:text-lg text-charcoal/80 mb-6 leading-relaxed">{active.description}</p>
                  <div className="space-y-4">
                    {active.bullets.map((b, index) => (
                      ...
                      >
                        ...
                        <span className="text-charcoal/80 font-medium text-sm sm:text-base">{b}</span>
                      </motion.div>
                    ))}
                  </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12 md:gap-16 max-w-5xl mx-auto px-4">
                <motion.div 
                  ...
                  transition={{ delay: 0.1 }}
                >
                  <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-charcoal mb-3">90%</div>
                  <div className="text-sm sm:text-base font-semibold text-charcoal/80 mb-2">Return to Work Rate</div>
                  <p className="text-sm sm:text-base text-charcoal/70">Of employees return to work with comprehensive parent support vs 57% national average</p>
                </motion.div>
                ...
                <motion.div 
                  ...
                  transition={{ delay: 0.2 }}
                >
                  <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-charcoal mb-3">94%</div>
                  <div className="text-sm sm:text-base font-semibold text-charcoal/80 mb-2">Higher Satisfaction</div>
                  <p className="text-sm sm:text-base text-charcoal/70">Of companies report higher employee satisfaction with family-friendly arrangements</p>
                </motion.div>
                ...
                <motion.div 
                  ...
                  transition={{ delay: 0.3 }}
                >
                  <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-charcoal mb-3">425%</div>
                  <div className="text-sm sm:text-base font-semibold text-charcoal/80 mb-2">Return on Investment</div>
                  <p className="text-sm sm:text-base text-charcoal/70">Childcare benefits deliver returns up to 425% of their cost for companies</p>
                </motion.div>
              </div>
            </div>
          </section>
