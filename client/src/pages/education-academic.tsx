...
import { ArrowLeft, GraduationCap, BookOpen, Clock, MessageCircle, Calendar, Users } from "lucide-react";
...
const specialists = [
  {
    ...
    about: "Educational Psychology & School Support Specialists guide families through Singapore's education system, from primary school selection to PSLE preparation. They provide academic support strategies and help navigate special educational needs.",
  ...
  },
  {
    ...
    about: "Education & Academic Guidance Specialists focus on supporting parents' mental health, stress management, and overall wellbeing throughout their parenting journey.",
...
export default function EducationAcademic() {
  ...
  const subCategories = [
    {
      ...
      description: "Strategic guidance for Direct School Admission applications and preparation.",
      icon: GraduationCap,
      color: "from-blue-500 to-cyan-500",
      topics: ["DSA application strategy", "Portfolio development", "Interview preparation", "School selection guidance", "Application timeline", "Success rate optimization"],
      matchedSpecialists: ["Dr. Catherine Wong"]
    },
    {
      id: "psle",
      title: "PSLE Preparation",
      description: "Comprehensive PSLE preparation strategies and academic support for primary school students.",
      icon: BookOpen,
      color: "from-green-500 to-emerald-500",
      topics: ["PSLE strategies", "Subject-specific preparation", "Exam techniques", "Stress management", "Study planning", "Mock exam practice"],
      matchedSpecialists: ["Dr. Catherine Wong"]
    }
  ];
  ...
  return (
    <>
      <SEOHead
        title="Education & Academic Guidance - Expert Support | AskFellow"
        description="Expert guidance for school choice, tutoring, exam preparation, DSA applications, and PSLE preparation. Get personalized academic support for your child's educational journey."
        keywords="education guidance, academic support, school choice, DSA, PSLE preparation, tutoring, exam preparation, Singapore education system"
        canonical="https://askfellow.com/education-academic"
      />
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-xs sm:text-sm font-medium text-primary">Academic Excellence</span>
                    </motion.div>
                    
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 sm:mb-6 px-2">
                      <span className="text-gradient-primary">Education & Academic</span>{" "}
                      <span className="text-charcoal">Guidance</span>
                    </h1>
                    <p className="text-base sm:text-lg lg:text-xl text-charcoal max-w-3xl mx-auto leading-relaxed px-4">
                      Expert advice on <span className="font-semibold text-secondary">school choice, tutoring, exam preparation, DSA applications, and PSLE strategies</span> for academic success.
                    </p>
                  </motion.div>
                ...
                >
                  <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-primary/10">
                    <h2 className="text-2xl lg:text-3xl font-bold text-charcoal mb-4">
                      Ready to Support Your Child's Academic Journey?
                    </h2>
                    <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                      Every child's educational path is unique. Connect with our expert specialists for personalized guidance 
                      tailored to your child's specific academic needs and goals.
                    </p>
