...
export default function SpecialComplexCare() {
  ...
  const subCategories = [
    {
      ...
      description: "Comprehensive support for families managing autism, ADHD, dyslexia, and other neurodivergent conditions.",
      icon: Brain,
      color: "from-blue-500 to-cyan-500",
      topics: ["Autism spectrum support", "ADHD management", "Dyslexia intervention", "Sensory processing", "Social skills development", "School accommodations"],
      matchedSpecialists: ["Dr. Rachel Lim", "Dr. Amelia Kumar"]
    },
    {
      id: "developmental-delays",
      title: "Developmental Delays",
      description: "Early intervention and support for children with developmental delays and learning challenges.",
      icon: Users,
      color: "from-green-500 to-emerald-500",
      topics: ["Early intervention", "Developmental assessments", "Speech therapy coordination", "Occupational therapy support", "School readiness", "Family education"],
      matchedSpecialists: ["Dr. Rachel Lim", "Dr. Ahmad Hassan"]
    },
    {
      id: "chronic-conditions",
      title: "Chronic Health Conditions",
      description: "Support for families managing chronic medical conditions and complex healthcare needs.",
      icon: Heart,
      color: "from-pink-500 to-rose-500",
      topics: ["Medical care coordination", "Treatment plan management", "Family education", "Emotional support", "School integration", "Transition planning"],
      matchedSpecialists: ["Dr. Ahmad Hassan", "Dr. Rachel Lim"]
    },
    {
      id: "mental-health",
      title: "Mental Health & Behavioral Support",
      description: "Specialized mental health support for children and adolescents with complex behavioral challenges.",
      icon: Brain,
      color: "from-purple-500 to-indigo-500",
      topics: ["Behavioral therapy", "Anxiety management", "Depression support", "Trauma-informed care", "Family therapy", "Crisis intervention"],
  ...
  return (
    <>
      <SEOHead
        title="Special & Complex Care Navigation - Expert Support for Families | AskFellow"
        description="Comprehensive support for families managing neurodivergence, developmental delays, chronic conditions, and complex healthcare needs from experienced specialists."
        keywords="special needs, complex care, neurodivergence, developmental delays, chronic conditions, autism, ADHD, early intervention"
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-xs sm:text-sm font-medium text-primary">Specialized Care</span>
                    </motion.div>
                    ...
                    <p className="text-base sm:text-lg lg:text-xl text-charcoal max-w-3xl mx-auto leading-relaxed px-4">
                      Expert guidance for families managing <span className="font-semibold text-secondary">neurodivergence, developmental delays, and complex healthcare needs</span> with{" "}
                ...
                >
                  <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-primary/10">
                    ...
                    <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                      Every family's care journey is unique. Connect with our expert specialists for personalized support 
                      tailored to your specific complex care needs and family situation.
                    </p>
