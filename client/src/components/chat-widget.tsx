...
export default function ChatWidget() {
  ...
  const [messages, setMessages] = useState([
    ...
    {
      id: 2,
      text: "Don't worry if you haven't found exactly what you're looking for on our website. Every family's journey is unique, and we understand that sometimes you need specialized guidance or resources that aren't immediately visible.",
      sender: "bot", 
      timestamp: new Date()
    },
    {
      id: 3,
      text: "Fill out our quick form and we'll connect you with the right specialist or resources for your family's unique needs.",
      sender: "bot", 
      timestamp: new Date()
    },
    // {
        ...
        {isOpen && (
          <div className="mb-4 w-72 sm:w-80 h-80 sm:h-96 bg-white rounded-xl sm:rounded-2xl shadow-2xl border border-gray-200 flex flex-col">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-xs sm:text-sm" data-testid="text-chat-title">
                    {isHumanAgent ? "Sarah - AskFellow Team" : "AskFellow"}
                  </h3>
            ...
            <div className="p-3 sm:p-4 border-t border-gray-200">
              {/* Fill Request Form Button */}
              <Button
                onClick={() => window.open('/request', '_blank')}
                className="w-full bg-secondary text-white hover:bg-secondary/90 py-3 text-sm font-medium"
                data-testid="button-fill-request-form"
              >
                Fill Request Form
              </Button>
            </div>
