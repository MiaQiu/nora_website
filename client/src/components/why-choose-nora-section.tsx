...
export default function WhyChooseNoraSection() {
  const features = [
    ...
    },
    {
      ...
      imageSrc: "/attached_assets/stock_images/family_counseling_th_8323dfc9.jpg"
    },
    {
      ...
      imageSrc: "/attached_assets/stock_images/diverse_team_of_prof_47901511.jpg"
    }
  ];
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 space-y-6">
                  <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-charcoal" data-testid={`text-why-title-${index}`}>
                    {feature.title}
                  </h3>
                  
                  <p className="text-lg sm:text-xl font-medium text-charcoal" data-testid={`text-why-headline-${index}`}>
                    {feature.headline}
                  </p>
                  
                  <p className="text-base sm:text-lg text-charcoal/70 leading-relaxed" data-testid={`text-why-description-${index}`}>
                    {feature.description}
                  </p>
                </div>
